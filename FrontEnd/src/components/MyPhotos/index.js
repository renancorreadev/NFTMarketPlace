...
export default class MyPhotos extends Component {
    ...
    render() {
        ...
        return (
            <div className="">
             <h2 className={styles.titles}>My NFTs</h2>
                      ...
                      <div className={styles.widgets}>
                          ...
                          { currentAccount == photo.ownerAddress ? 
                              ...
                              >
                                ...
                                <p>NFT name: { photo.photoNFTName }</p>

                                <p>Price: { web3.utils.fromWei(`${photo.photoPrice}`, 'ether') } BNB</p>

                                <p >Owner: <a  className={styles.titleAddress} href={`https://testnet.bscscan.com/address/${photo.ownerAddress}`}>{photo.ownerAddress}</a></p>
                                
                                <br />

                                { photo.status == "Cancelled" ? 
                                    <Button style={{
                                      backgroundColor: ' background: linear-gradient(to right, #4fa46f 0%, #79c17e 100%)'
                                    }} size={'medium'} width={1} value={ photo.photoNFT } onClick={this.putOnSale}> Put on sale </Button>
                                :
                                    <Button style={{
                                      backgroundColor: ' background: linear-gradient(to right, #4fa46f 0%, #79c17e 100%)'
                                    }}  size={'medium'} width={1} value={ photo.photoNFT } onClick={this.cancelOnSale}> Cancel on sale </Button>
                                }
